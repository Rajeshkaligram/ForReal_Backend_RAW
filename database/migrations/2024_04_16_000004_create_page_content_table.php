...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('page_content')->insert([
            ...
            ['page_id' => 1, 'section_id' => 3, 'field_type' => 'repeater', 'field_name' => 'Process Steps', 'repeater_fields' => serialize([['field_type' => 'image', 'field_name' => 'Step Image'], ['field_type' => 'text', 'field_name' => 'Step Title'], ['field_type' => 'text', 'field_name' => 'Step Description']]), 'content' => base64_encode(serialize([[['field_type' => 'image', 'field_name' => 'Step Image', 'field_value' => 'uploads/cms/process-step1.jpg'], ['field_type' => 'text', 'field_name' => 'Step Title', 'field_value' => 'Browse'], ['field_type' => 'text', 'field_name' => 'Step Description', 'field_value' => 'Browse through our collection']], [['field_type' => 'image', 'field_name' => 'Step Image', 'field_value' => 'uploads/cms/process-step2.jpg'], ['field_type' => 'text', 'field_name' => 'Step Title', 'field_value' => 'Select'], ['field_type' => 'text', 'field_name' => 'Step Description', 'field_value' => 'Select your favorite items']], [['field_type' => 'image', 'field_name' => 'Step Image', 'field_value' => 'uploads/cms/process-step3.jpg'], ['field_type' => 'text', 'field_name' => 'Step Title', 'field_value' => 'Rent'], ['field_type' => 'text', 'field_name' => 'Step Description', 'field_value' => 'Rent and enjoy']]])), 'created_at' => now(), 'updated_at' => now()],
