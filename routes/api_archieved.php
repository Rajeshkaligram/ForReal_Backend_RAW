...
// Route::group(['middleware' => API_MIDDLEWARE_NAME , 'prefix' => API_PREFIX], function () {

//     Route::get('braintree/get_client_token','Api\PlaceOrderController@getClientToken');
//     Route::post('place_order/new','Api\PlaceOrderController@placeOrderNew');
// });

// Route::get('paymentCancel/{id}', 'Api\RentedController@payment_cancel');
// Route::get('paymentSuccess/{id}', 'Api\RentedController@payment_success');
...
//     Route::get('proceed-checkout/{id}', 'Api\RentedController@payRental');
...
//     Route::get("news",array('uses' => 'Api\BlogsController@getNews'));
...
// 	Route::get('config',array('uses' =>'Api\UserController@getConfig'));
